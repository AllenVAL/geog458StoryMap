...
![Screenshot of GeoNarrative](img/shot.png)

---

## Data Sources

- Farmers Market locations (GeoJSON) — processed using QGIS  
- Basemap — Mapbox GL JS  
- GeoNarrative template — Humanistic GIS Lab, University of Washington  
